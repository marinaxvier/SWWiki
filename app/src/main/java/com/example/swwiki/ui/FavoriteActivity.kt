...
import com.example.swwiki.utils.SwipeToDelete
...
class FavoriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        repository = Repository(favoriteDAO)
    ...
    private fun adapterConfig() {
        var listAdapter = FavoriteListAdapter(this, favorites as ArrayList<Favorite>, repository)
        ...
        var itemTouchHelper = ItemTouchHelper(SwipeToDelete(listAdapter))
